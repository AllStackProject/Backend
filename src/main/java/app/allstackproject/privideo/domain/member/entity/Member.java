package app.allstackproject.privideo.domain.member.entity;
...
import static app.allstackproject.privideo.global.response.status.BaseExceptionResponseStatus.ALREADY_REJECTED_MEMBER;
