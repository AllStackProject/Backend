...
import static app.allstackproject.privideo.domain.organization.dto.enums.JoinStatusType.REJECTED;
import static app.allstackproject.privideo.domain.video.enums.S3ImgType.ORG;
import static app.allstackproject.privideo.global.response.status.BaseExceptionResponseStatus.ALREADY_APPROVED_MEMBER;
import static app.allstackproject.privideo.global.response.status.BaseExceptionResponseStatus.ALREADY_LEAVED_MEMBER;
import static app.allstackproject.privideo.global.response.status.BaseExceptionResponseStatus.ALREADY_REQUESTED_MEMBER;
import static app.allstackproject.privideo.global.response.status.BaseExceptionResponseStatus.DUPLICATE_NICKNAME;
...
import static app.allstackproject.privideo.domain.organization.util.OrgCodeGenerator.generateCode;
...
import app.allstackproject.privideo.global.security.OrgTokenDto;
