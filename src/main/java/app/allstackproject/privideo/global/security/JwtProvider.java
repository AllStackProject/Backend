...
import static app.allstackproject.privideo.shared.enums.TokenType.BOOTSTRAP;
import static app.allstackproject.privideo.shared.enums.TokenType.ORG;
import static app.allstackproject.privideo.global.response.status.BaseExceptionResponseStatus.EXPIRED_TOKEN;
import static app.allstackproject.privideo.global.response.status.BaseExceptionResponseStatus.INVALID_TOKEN;
